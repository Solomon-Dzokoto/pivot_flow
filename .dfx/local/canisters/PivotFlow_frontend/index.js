...
import { idlFactory } from './PivotFlow_frontend.did.js';
export { idlFactory } from './PivotFlow_frontend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_PIVOTFLOW_FRONTEND;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./PivotFlow_frontend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the PivotFlow_frontend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./PivotFlow_frontend.did.js")._SERVICE>}
 */
export const PivotFlow_frontend = createActor(canisterId);
