...
import { idlFactory } from './PivotFlow_backend.did.js';
export { idlFactory } from './PivotFlow_backend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_PIVOTFLOW_BACKEND;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./PivotFlow_backend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the PivotFlow_backend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./PivotFlow_backend.did.js")._SERVICE>}
 */
export const PivotFlow_backend = createActor(canisterId);
